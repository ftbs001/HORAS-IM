...
const TableOfContents = () => {
    ...
    const defaultTocData = [
        ...
        { id: '1c', text: 'c.Paspor 24 Hal pada Unit Layanan Paspor (ULP) Tebing Tinggi', page: 10, level: 3 },
        { id: '1d', text: 'd.Pas Lintas Batas (PLB)', page: 10, level: 3 },
        { id: '1e', text: 'e.Surat Perjalanan Laksana Paspor (SPLP)', page: 11, level: 3 },
