                            ...
                            <div>
                                ...
                                <div className="relative group">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-12 pr-12 py-3.5 bg-[#0a1a30]/50 border border-white/10 rounded-xl text-white placeholder-blue-400/50 focus:outline-none focus:ring-2 focus:ring-imigrasi-gold/50 focus:bg-[#0a1a30]/80 transition-all font-medium"
                                        placeholder="••••••••"
                                    />
                                    <button
                                        type="button"
                                        ...
                                        tabIndex={-1}
                                        className="absolute right-4 top-1/2 transform -translate-y-1/2 text-blue-300 hover:text-imigrasi-gold transition-colors focus:outline-none"
                                ...
                                <div>
                                    ...
                                    <div className="relative group">
                                        <input
                                            ...
                                            className="w-full px-4 pr-12 py-3 bg-[#0a1a30]/50 border border-white/10 rounded-xl text-white placeholder-blue-400/50 focus:outline-none focus:ring-2 focus:ring-imigrasi-gold/50 transition-all text-sm"
