...
══════════════════════════════════════════════════════════════════════════════ */
export function getLalintalkimDocxElements(templateData) {
    const {
    ...
    return [
        subHeading('1. PENERBITAN DOKUMEN PERJALANAN REPUBLIK INDONESIA'),
        spacer(),
        ...
        subHeading('2. PENERBITAN IZIN TINGGAL'),
        spacer(),
        ...
        heading('3. REKAPITULASI DATA PERLINTASAN'),
