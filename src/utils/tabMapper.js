...
export const TAB_OPTIONS = [
    ...
    { value: 'bab2_substantif_dokumen_paspor24_tebing', label: '      c. Paspor 24H — ULP Tebing' },
    { value: 'bab2_substantif_dokumen_plb', label: '      d. Pas Lintas Batas' },
    { value: 'bab2_substantif_dokumen_splp', label: '      e. SPLP' },
